...
class TextPicker: BasePicker {
    ...
    override func viewDidLoad() {
        ...
        cancelButton.setTitleColor(Constants.color.appHighlightText, for: .normal)
        doneButton.setTitleColor(Constants.color.appHighlightText, for: .normal)
    }
    ...
    private func setUpLocalizable() {
        doneButton.setTitle("feedback_people_to_choose".localized, for: .normal)
        cancelButton.setTitle("feedback_people_cancel".localized, for: .normal)
    }
