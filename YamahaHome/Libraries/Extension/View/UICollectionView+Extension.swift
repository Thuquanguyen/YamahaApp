...
extension UICollectionView {
    ...
    func setup<T: UICollectionViewCell>(_ data: UICollectionViewDataSource & UICollectionViewDelegate, cells: T.Type ...) {
        set(delegateAndDataSource: data)
        cells.forEach{ registerNibCellFor(type: $0)}
    }
